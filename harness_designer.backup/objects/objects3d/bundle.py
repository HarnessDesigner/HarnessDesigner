...
class Bundle(_base3d.Base3D, wxOpenGL.MeshGeneric):
    ...
    def __init__(self, parent: "_bundle.Bundle",
        ...
        self._p2.bind(self._update_position2)

        wxOpenGL.MeshGeneric.__init__(self, self.editor3d.canvas, material,
                                      selected_material, Config.modeling.smooth_bundles,
                                      [], self._p1)
    ...
    def _update_position(self, point: _point.Point):
        self._build()
        super()._update_position(point)

    def _update_position2(self, point: _point.Point):
        self._build()
        super()._update_position(point)
    ...
    def _build(self):
        ...
        self._mesh = [list(_build_model(self._p1, self._p2, self._diameter))]
        self._position = self._p1

        self._angle = _angle.Angle.from_points(self._p1, self._p2)
