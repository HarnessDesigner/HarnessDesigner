...
from ...gl import canvas_schematic as _canvas_schematic
...
class EditorSchematic(_dock_base.DockBase):
    ...
    def __init__(self, mainframe: "_mainframe.MainFrame"):
        ...
        self._ui_obj = EditorSchematicPanel(mainframe)
        super().__init__(mainframe, 'Schematic Editor', 'editor_2d',
                         QtCore.Qt.DockWidgetArea.RightDockWidgetArea)

    @property
    @_check_types.do
    def editor(self) -> "EditorSchematicPanel":
        return self._ui_obj
...
class EditorSchematicPanel(_canvas_schematic.CanvasSchematic):
