...
class CoversPage(_base.EditorList):
    ...
    column_mapping = {
        0: ('DB ID', {'alias': 'id', 'field_name': 'id'}),
        1: ('Part Number', {'alias': 'part_number', 'field_name': 'part_number'}, True),
        2: ('Description', {'alias': 'description', 'field_name': 'description'}, True),
        ...
        7: ('Direction', {'alias': 'direction_name', 'field_name': 'direction_id', 'ref_table': 'directions', 'ref_field': 'name'}),
        8: ('Temperature (min)', {'alias': 'min_temp_name', 'field_name': 'min_temp_id', 'ref_table': 'temperatures', 'ref_field': 'name'}),
        9: ('Temperature (max)', {'alias': 'max_temp_name', 'field_name': 'max_temp_id', 'ref_table': 'temperatures', 'ref_field': 'name'}),
