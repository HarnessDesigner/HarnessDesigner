...
class CPALocksModel(_model_base.ModelBase):
...
class CPALocksPanel(wx.Panel):
    def __init__(self, parent, table: "_cpa_lock.CPALocksTable"):
        ...
        self.model = CPALocksModel(table)
