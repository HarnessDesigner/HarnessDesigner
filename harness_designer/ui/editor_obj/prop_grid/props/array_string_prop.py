...
class ArrayStringDialog(wx.Dialog):

    def __init__(self, parent, values, title='Modify Array'):
        wx.Dialog.__init__(self, parent, wx.ID_ANY, title=title, size=(300, 500),
                           style=wx.RESIZE_BORDER | wx.CLOSE_BOX | wx.STAY_ON_TOP | wx.CAPTION)
...
class ArrayStringProperty(_prop_base.Property):
    ...
    def _on_dialog_button(self, _):
        dlg = ArrayStringDialog(self._parent_window, self._value, self._dialog_title)
        dlg.CenterOnParent()
