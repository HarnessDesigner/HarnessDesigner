...
class Position3DProperty(_prop_base.Property):
    ...
    def __init__(self, parent, label):
        ...
        self._position = None
        self.x_ctrl = _float_prop.FloatProperty(self, 'X', min_value=-9999.0, max_value=9999.0, increment=0.01, units='mm')
        self.y_ctrl = _float_prop.FloatProperty(self, 'Y', min_value=0.0, max_value=9999.0, increment=0.01, units='mm')
        self.z_ctrl = _float_prop.FloatProperty(self, 'Z', min_value=-9999.0, max_value=9999.0, increment=0.01, units='mm')
