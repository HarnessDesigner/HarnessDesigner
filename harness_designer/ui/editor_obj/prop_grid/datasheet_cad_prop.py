...
class DatasheetCADCtrl(wx.Panel):
    ...
    def __init__(self, parent, file_types, original_path, saved_path, size, pos):
        ...
        self.image_ctrl = wx.StaticBitmap(
            self, wx.ID_ANY, bitmap=_image.images.no_image.resize(100, 100).bitmap,
...
class DatasheetCADEditor(wxpg.PGEditor):
    ...
    def CreateControls(self, propgrid, prop, pos, sz):
        ...
        ctrl = DatasheetCtrl(propgrid.GetPanel(), file_types, original_path, saved_path, (w, h), pos)
...
class DatasheetCADProperty(wxpg.PGProperty):
    ...
    def DoGetEditorClass(self):
        return wxpg.PropertyGridInterface.GetEditorByName("DatasheetCAD")
