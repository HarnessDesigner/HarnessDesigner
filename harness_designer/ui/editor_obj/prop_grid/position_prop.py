...
class Position3DProperty(wxpg.PGProperty):
    def __init__(self, label, name, value: "_point.Point"):
        wxpg.PGProperty.__init__(self, label, name)

        self.AddPrivateChild(_float_prop.FloatProperty(
            "X", 'x', value=value.x, min_value=-999.0,
            max_value=999.0, increment=0.01, units='mm'))
...
class Position2DProperty(wxpg.PGProperty):
    def __init__(self, label, name, value: "_point.Point"):
        wxpg.PGProperty.__init__(self, label, name)

        self.AddPrivateChild(_float_prop.FloatProperty(
            "X", 'x', value=value.x, min_value=-999.0,
            max_value=999.0, increment=0.01))
