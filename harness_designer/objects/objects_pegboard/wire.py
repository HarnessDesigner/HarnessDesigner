...
class WireMenu(QMenu):
    """Right-click menu for a pegboard Wire."""

    @_check_types.do
    def __init__(self, canvas, selected: Wire):
        QMenu.__init__(self)
        self.canvas = canvas
    ...
    def on_add_waypoint(self):
        ...
        add_handlers.editor_pegboard.wire_layout), seeded at the point
        ...
        @_check_types.do
        def _do():
            _wire_layout_pegboard.WireLayout.start_add(mainframe, wire, initial_pos)
