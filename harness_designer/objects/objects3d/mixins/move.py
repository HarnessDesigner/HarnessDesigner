...
#
#
# class ArrowMove(_base3d.Base3D, wxOpenGL.MeshGeneric):
#
#     @_debug.timeit
#     def __init__(self, parent: "MoveMixin", position: _point.Point,
#                  angle: _angle.Angle, scale,
#                  color: list[float, float, float, float],
#                  press_color: list[float, float, float, float]):
#
#         _base3d.Base3D.__init__(self, parent.mainframe)
#
...
#         tris += position
#
#         material = wxOpenGL.MetallicMaterial(color)
#         selected_material = wxOpenGL.MetallicMaterial(press_color)
#
#         wxOpenGL.MeshGeneric.__init__(self, self.editor3d.canvas, material, selected_material,
#                                       False, [[tris, nrmls, count]], parent.position)
#
#
# class MoveMixin:
...
#         wxOpenGL.Base3D._update_position(self, point)  # NOQA
#
#     @_debug.timeit
#     def start_move(self):
#         p1, p2 = self._rect[0]
