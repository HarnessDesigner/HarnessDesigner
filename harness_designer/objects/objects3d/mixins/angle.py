...
#
#     def __init__(self, parent: "AngleMixin", center: _point.Point, radius: float,
#                  angle: _angle.Angle, scale: float, color: list[float, float, float, float],
...
#         if angle.y:
#             opposite_angle.y += _d(90.0)
#             start_angle = 180.0
#         elif angle.x:
#             opposite_angle.y += _d(180.0)
#             start_angle = 180.0
#         else:
#             opposite_angle.y = _d(180.0)
#             start_angle = 0.0
...
#
#         self._material = _materials.Metallic(color)
#         self._press_material = _materials.Metallic(press_color)
#
#         # self._triangles = [
...
#
#         detent_setting = _d(self.mainframe.editor3d.cp.detent)
#
#         if detent_setting == 0:
#             self._last_detent_counts = None
#         else:
#             if self._last_detent_counts is None:
#                 self._last_detent_counts = [_d(int(angle.x / detent_setting)),
#                                             _d(int(angle.y / detent_setting)),
#                                             _d(int(angle.z / detent_setting))]
#
#             cx, cy, cz = self._last_detent_counts
#             new_angle = angle + delta
#
#             new_cx = _d(int(new_angle.x / detent_setting))
#             new_cy = _d(int(new_angle.y / detent_setting))
#             new_cz = _d(int(new_angle.z / detent_setting))
#
#             if new_cx != cx:
...
#                 x_plane_delta = _angle.Angle(delta.x, delta.y, _d(0.0))
...
#         scale = diameter / _d(30.0)
#
#         center = self.position
#         radius = diameter / _d(2.0) * _d(1.1)
#
#         angle = self.angle
#
