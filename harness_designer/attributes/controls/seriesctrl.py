...
class SeriesCtrl(wx.Panel):
    ...
    def on_choice(self, evt: wx.CommandEvent):
        ...
        self.series_db_obj = self.global_db.series_table[name]
        self.mfg_ctrl.SetDBObject(self.series_db_obj.manufacturer)
        self.desc_ctrl.SetValue(self.series_db_obj.description)
        evt.Skip()

    def SetDBObject(self, db_obj: _series.Series) -> None:
        self.series_db_obj = db_obj
    ...
    def GetValue(self) -> int:
        ...
        try:
            return self.global_db.series_table[name].db_id
        except KeyError:
            return self.global_db.series_table.insert(name, self.mfg_ctrl.GetValue(), self.desc_ctrl.GetValue()).db_id