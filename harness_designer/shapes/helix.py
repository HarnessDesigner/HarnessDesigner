...
def create_vbo() -> _vbo_handler.VBOHandler:
    ...
    if _vbo is None:
        model = build123d.Cylinder(0.5, 1.0, align=build123d.Align.NONE)
        ...
        edges = edges.trim_to_length(0, 1.0 / 3.0)
        ...
        s_line = build123d.Line(wire_axis.position, 1.0 * wire_axis.direction)
