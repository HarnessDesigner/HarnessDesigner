...
pjt_table = _con.SQLTable(
    ...
    _con.UUIDField('point_pegboard_id', default="NULL",
                   references=_con.SQLFieldReference(_points_pegboard.pjt_table,
                                                     ...
                                                     on_delete=_con.REFERENCE_NO_ACTION,
                                                     on_update=_con.REFERENCE_NO_ACTION)),
    # Peg-board mirrors of terminal_point3d_id/wire_point3d_id above --
    # same lazily-created-on-first-access shape, just against
    # pjt_points_pegboard instead of pjt_points3d.
    _con.UUIDField('terminal_point_pegboard_id', default='NULL',
                   references=_con.SQLFieldReference(_points_pegboard.pjt_table,
                                                     _points_pegboard.pjt_id_field,
                                                     on_delete=_con.REFERENCE_NO_ACTION,
                                                     on_update=_con.REFERENCE_NO_ACTION)),
