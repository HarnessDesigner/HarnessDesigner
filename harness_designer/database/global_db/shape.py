...
class ShapesTable(TableBase):
    """Represent a shapes table in :mod:`harness_designer.database.global_db.shape`.
...
class Shape(EntryBase, NameMixin):
    """Represent a shape in :mod:`harness_designer.database.global_db.shape`.
