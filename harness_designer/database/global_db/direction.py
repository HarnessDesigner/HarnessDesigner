...
class DirectionsTable(TableBase):
    """Represent a directions table in :mod:`harness_designer.database.global_db.direction`.
...
class Direction(EntryBase, NameMixin):
    """Represent a direction in :mod:`harness_designer.database.global_db.direction`.
