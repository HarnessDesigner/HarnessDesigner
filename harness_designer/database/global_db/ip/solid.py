...
class IPSolidsTable(TableBase):
    """Represent an ip solids table in :mod:`harness_designer.database.global_db.ip.solid`.
...
class IPSolid(EntryBase, NameMixin, DescriptionMixin):
    """Represent an ip solid in :mod:`harness_designer.database.global_db.ip.solid`.
