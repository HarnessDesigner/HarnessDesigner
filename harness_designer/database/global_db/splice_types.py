...
class SpliceTypesTable(TableBase):
    """Represent a splice types table in :mod:`harness_designer.database.global_db.splice_types`.
...
class SpliceType(EntryBase, NameMixin):
    """Represent a splice type in :mod:`harness_designer.database.global_db.splice_types`.
