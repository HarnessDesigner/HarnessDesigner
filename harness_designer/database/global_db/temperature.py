...
class TemperaturesTable(TableBase):
    """Represent a temperatures table in :mod:`harness_designer.database.global_db.temperature`.
...
class Temperature(EntryBase, NameMixin):
    """Represent a temperature in :mod:`harness_designer.database.global_db.temperature`.
