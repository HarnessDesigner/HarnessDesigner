...
KEY_MULTIPLES = {
    ...
    ord('-'): [ord('-'), Qt.Key.Key_Minus],
    Qt.Key.Key_Minus: [ord('-'), Qt.Key.Key_Minus],

    ord('+'): [ord('+'), Qt.Key.Key_Plus],
    Qt.Key.Key_Plus: [ord('+'), Qt.Key.Key_Plus],

    ord('/'): [ord('/'), Qt.Key.Key_Slash],
    Qt.Key.Key_Slash: [ord('/'), Qt.Key.Key_Slash],

    ord('*'): [ord('*'), Qt.Key.Key_Asterisk],
    Qt.Key.Key_Asterisk: [ord('*'), Qt.Key.Key_Asterisk],

    ord('.'): [ord('.'), Qt.Key.Key_Period],
    Qt.Key.Key_Period: [ord('.'), Qt.Key.Key_Period],

    ord('|'): [ord('|'), Qt.Key.Key_Bar],
    Qt.Key.Key_Bar: [ord('|'), Qt.Key.Key_Bar],

    ord(' '): [ord(' '), Qt.Key.Key_Space],
    Qt.Key.Key_Space: [ord(' '), Qt.Key.Key_Space],

    ord('='): [ord('='), Qt.Key.Key_Equal],
    Qt.Key.Key_Equal: [ord('='), Qt.Key.Key_Equal],
    ...
    ord('0'): [ord('0'), Qt.Key.Key_0],
    ord('1'): [ord('1'), Qt.Key.Key_1],
    ord('2'): [ord('2'), Qt.Key.Key_2],
    ord('3'): [ord('3'), Qt.Key.Key_3],
    ord('4'): [ord('4'), Qt.Key.Key_4],
    ord('5'): [ord('5'), Qt.Key.Key_5],
    ord('6'): [ord('6'), Qt.Key.Key_6],
    ord('7'): [ord('7'), Qt.Key.Key_7],
    ord('8'): [ord('8'), Qt.Key.Key_8],
    ord('9'): [ord('9'), Qt.Key.Key_9]
}
