...
class Line:
    ...
    def __contains__(self, test_point: _point.Point):
        ...
        tolerance = 1e-10  # NOQA

        # Vector from p1 to p2
        line_vec = p2 - p1

        # Vector from p1 to test_point
        point_vec = test_point - p1

        # Calculate cross product to check collinearity
        cross = np.cross(line_vec, point_vec)  # NOQA

        # If cross product magnitude is not zero, point is not on the line
    ...
    def project_to_line(self, world_point: _point.Point):
        ...
        # Calculate the parameter t (0 to 1) along the line
        # This is the projection of point_vec onto line_vec
        ...
        projected_point = _point.Point(*[float(item) for item in projected_point])
